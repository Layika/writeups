...
for i in range(50):
    ...
    for row in range(height):
        chunks[row] = [chunks[row][i*5:i*5+3] for i in range(len(chunks[row])/5)] # 5 = 3 for letter, 2 for space between
    ...
    chunks_a = ['*']*height                                                       # in order to make it easier to recognize the digits we convert digits to '*'
